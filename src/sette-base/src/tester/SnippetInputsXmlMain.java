...
import hu.bme.mit.sette.common.model.runner.xml.ArrayParameterElement;
...
public final class SnippetInputsXmlMain {
    public static void main(final String[] args) throws Exception {
        ...
        snippetInputsXml.getSnippetElement().setContainerName(
        ...
        i1.getParameters().add(
                new ParameterElement(ParameterType.INT, "0"));
        i1.getParameters().add(
                new ParameterElement(ParameterType.DOUBLE, "1.0"));

        InputElement i2 = new InputElement();
        i2.getParameters().add(
                new ParameterElement(ParameterType.FLOAT, "1.2"));
        i2.getParameters().add(
                new ParameterElement(ParameterType.CHAR, "c"));

        InputElement i3 = new InputElement();
        ArrayParameterElement i3p1 = new ArrayParameterElement(
                ParameterType.INT);
        i3p1.getElements().add("1");
        i3p1.getElements().add("2");
        ArrayParameterElement i3p2 = new ArrayParameterElement(
                ParameterType.CHAR);
        ...
        i4.getParameters().add(
                new ParameterElement(ParameterType.EXPRESSION,
                        "\"str\""));
        i4.getParameters()
        .add(new ParameterElement(ParameterType.EXPRESSION,
                "new String(\"str\")+\"str1\"+\"str2\".concat(\"str3\")"));

        InputElement i5 = new InputElement();
        i5.getParameters().add(
                new ParameterElement(ParameterType.EXPRESSION,
                        "\"str\""));
        i5.getParameters()
        .add(new ParameterElement(ParameterType.EXPRESSION,
        ...
        i8.setHeap(i8Heap);
        i8.getParameters().add(
                new ParameterElement(ParameterType.EXPRESSION, "p1"));
        i8.getParameters().add(
                new ParameterElement(ParameterType.EXPRESSION, "p2"));
        ...
        snippetInputsXml = serializer.read(SnippetInputsXml.class, s
                .getBuffer().toString());
        s = new StringWriter();
