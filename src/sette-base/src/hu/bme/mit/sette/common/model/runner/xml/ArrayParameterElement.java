 ...
 */
public final class ArrayParameterElement extends
AbstractParameterElement {
    /** The elements of the array parameter. */
    @ElementList(inline = true, entry = "element", data = true,
            type = String.class)
     ...
     */
    public ArrayParameterElement(final ParameterType type) {
        super(type);
        elements = new ArrayList<>();
    }
     ...
     * #validate2(hu.bme.mit.sette.common.validator.GeneralValidator)
     */
    @Override
