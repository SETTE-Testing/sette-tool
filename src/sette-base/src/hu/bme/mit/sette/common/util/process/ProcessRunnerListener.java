...
public interface ProcessRunnerListener {
     ...
     */
    void onStdoutRead(ProcessRunner processRunner, int charactersRead);
     ...
     *            the number of the read characters
     */
    void onStderrRead(ProcessRunner processRunner, int charactersRead);
     ...
     *            the exception
     */
    void onIOException(ProcessRunner processRunner,
