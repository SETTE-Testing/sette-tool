...
public final class FieldValidator extends AbstractValidator<Field> {
    ...
    public void addException(String message, Throwable cause) {
        this.addException(new FieldValidationException(message, getSubject(), cause));
    }
     ...
     * @return this object
     */
    public FieldValidator withModifiers(int modifiers) {
        if (getSubject() != null) {
            Field field = getSubject();

            if ((field.getModifiers() & modifiers) != modifiers) {
                this.addException(String.format(
                        "The field must have all the specified modifiers\n" + "(modifiers: [%s])",
     ...
     * @return this object
     */
    public FieldValidator withoutModifiers(int modifiers) {
        if (getSubject() != null) {
            Field field = getSubject();

            if ((field.getModifiers() & modifiers) != 0) {
                this.addException(
                        String.format("The field must not have any of the specified modifiers"
                                + "\n(modifiers: [%s])", Modifier.toString(modifiers)));
            }
        }
     ...
     *
     * @param isSynthetic
     *            true if the field should be synthetic, false if it should not be
     * @return this object
     */
    public FieldValidator synthetic(boolean isSynthetic) {
        if (getSubject() != null) {
            Field field = getSubject();
            ...
            if (isSynthetic ^ field.isSynthetic()) {
                ...
                this.addException(String.format("The field %s be synthetic", must));
            }
        }
