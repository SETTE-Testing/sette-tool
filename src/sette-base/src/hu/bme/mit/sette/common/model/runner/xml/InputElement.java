...
public final class InputElement implements XmlElement {
    ...
    /** The parameters. */
    @ElementListUnion({
        @ElementList(type = ParameterElement.class, entry = ""
                + "parameter", inline = true, required = false),
                @ElementList(type = ArrayParameterElement.class, entry = ""
                        + "arrayParameter", inline = true, required = false) })
     ...
     */
    public void setExpected(final String pExpected) {
        expected = pExpected;
    }
    ...
    public void validate() throws ValidatorException {
        ...
        if (parameters == null) {
            ...
            v.addException("The list of parameters must not contain"
                    + "a null element");
        }
