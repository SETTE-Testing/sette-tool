...
public final class SampleManualInputsCsvGenerator {
    public static void main(String[] args) throws Exception {
        SnippetProjectSettings settings = new SnippetProjectSettings(
                new File("../../../sette-snippets/sette-snippets").getCanonicalFile());
        SnippetProject snippetProject = new SnippetProject(settings);
        snippetProject.parse();
