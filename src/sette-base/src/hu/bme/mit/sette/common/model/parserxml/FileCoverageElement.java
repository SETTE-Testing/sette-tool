...
public class FileCoverageElement implements XmlElement {
    ...
    public void validate() throws ValidatorException {
        ...
        Collection<Integer> intersection1 = CollectionUtils.intersection(setA, setB);
        Collection<Integer> intersection2 = CollectionUtils.intersection(setA, setC);
        Collection<Integer> intersection3 = CollectionUtils.intersection(setB, setC);
        ...
        if (!union.isEmpty()) {
            ...
            v.addException(
                    "No common elements are allowed (" + StringUtils.join(union, ", ") + ")");
        }
     ...
     */
    private static Set<Integer> validateAndGetLineNumbers(String lines,
            ...
            try {
                ...
                if (lineNumber >= 1) {
                    if (!lineNumbers.contains(lineNumber)) {
                        ...
                        validator.addException("Duplicates are not allowed");
                    }
                } else {
                    validator.addException("Only positive integers are allowed");
                }
            } catch (NumberFormatException e) {
                validator.addException("Only positive integers are allowed (invalid: " + part + ")",
                        e);
            }
        }
