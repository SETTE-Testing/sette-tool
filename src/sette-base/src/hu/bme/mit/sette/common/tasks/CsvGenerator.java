...
public final class CsvGenerator extends SetteTask<Tool> {
    ...
    public CsvGenerator(SnippetProject snippetProject, File outputDirectory, Tool tool,
    ...
    public void generate() throws Exception {
        ...
        FileUtils.writeLines(getCsvFile(), lines);
    }

    public File getCsvFile() {
        return new File(getRunnerProjectSettings().getBaseDirectory(), "sette-evaluation.csv");
    }
    ...
    private String createRow(Snippet snippet) throws Exception {
        ...
        String elapsedTime;
        if (infoFile.exists()) {
            elapsedTime = FileUtils.readLines(infoFile).stream()
