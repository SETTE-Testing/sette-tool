 ...
 */
public final class ConstructorValidationException extends
ValidationException {
     ...
     *            the constructor
     */
    public ConstructorValidationException(final String message,
            final Constructor<?> pConstructor) {
        this(message, pConstructor, null);
    }
     ...
     */
    public ConstructorValidationException(final String message,
            final Constructor<?> pConstructor, final Throwable cause) {
        super(message
                + String.format("\n(constructor: [%s])", pConstructor),
                cause);
