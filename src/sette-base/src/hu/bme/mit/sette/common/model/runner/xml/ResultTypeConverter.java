...
public final class ResultTypeConverter implements Converter<ResultType> {
     ...
     */
    @Override
    public ResultType read(final InputNode node) throws Exception {
        return ResultType.fromString(node.getValue().trim());
    }
     ...
     */
    @Override
    public void write(final OutputNode node, final ResultType value)
            throws Exception {
