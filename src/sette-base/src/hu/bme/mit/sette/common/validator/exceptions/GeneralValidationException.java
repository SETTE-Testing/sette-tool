 ...
 */
public final class GeneralValidationException extends ValidationException {
    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = -4283130565417524512L;

    /**
     * Instantiates a new general validation exception.
     *
     * @param message
     *            the message
     */
