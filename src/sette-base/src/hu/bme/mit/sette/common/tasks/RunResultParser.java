...
public abstract class RunResultParser<T extends Tool> extends
SetteTask<T> {
    public RunResultParser(final SnippetProject snippetProject,
    ...
    public final void parse() throws Exception {
        if (!RunnerProjectUtils.getRunnerLogFile(
            ...
            throw new SetteGeneralException(
                    "Run the tool on the runner project first");
        }
    ...
    private SnippetInputsXml parseSnippet(final Snippet snippet)
            throws Exception {
        // TODO validation?
        ...
        inputsXml.setSnippetElement(new SnippetElement(snippet
    ...
    protected abstract void parseSnippet(Snippet snippet,
