...
public final class SnippetResultXml extends SnippetBaseXml {
     ...
     *
     * @param pStatementCoverage
     *            the new statement coverage
     */
    public void setStatementCoverage(final double pStatementCoverage) {
        statementCoverage = pStatementCoverage;
    }
     ...
     */
    @Override
    protected void validate2(final GeneralValidator v) {
        ...
        if (statementCoverage < SetteRequiredStatementCoverage.MIN
            ...
            v.addException(String.format(
                    "The statement coverage must be "
                            + "between %.2f%% and %.2f%%",
