...
public final class JavaFileUtils {
    ...
    /**
     * Converts a filename to a Java package name by transliterating the file separator characters
     * to the package separator character.
     *
     * @param filename
    ...
    /**
     * Converts a Java package name to filename by transliterating the package separator characters
     * to the file separator charater.
     *
     * @param packageName
    ...
    public static String packageNameToFilename(String packageName) {
        return StringUtils.replaceChars(packageName, JavaFileUtils.PACKAGE_SEPARATOR,
                File.separatorChar);
    }

    /**
     * Converts a filename to a Java class name by transliterating the file separator characters to
    ...
    /**
     * Converts a Java class name to source filename by transliterating the package separator
     * characters to the file separator charater and adding the extension.
     *
     * @param className
    ...
    public static String classNameToSourceFilename(String className) {
        return JavaFileUtils.packageNameToFilename(className)
                + JavaFileUtils.FILE_EXTENSION_SEPARATOR + JavaFileUtils.JAVA_SOURCE_EXTENSION;
    }

    /**
     * Converts a Java class name to class filename by transliterating the package separator
     * characters to the file separator charater and adding the extension.
     *
     * @param className
     *            The class name (e.g. hu.bme.mit.sette.MyClass)
    ...
    public static String classNameToClassFilename(String className) {
        ...
        return JavaFileUtils.packageNameToFilename(className)
                + JavaFileUtils.FILE_EXTENSION_SEPARATOR + JavaFileUtils.JAVA_CLASS_EXTENSION;
    }
}
