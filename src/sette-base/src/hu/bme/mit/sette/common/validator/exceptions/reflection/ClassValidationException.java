...
public final class ClassValidationException extends ValidationException {
     ...
     *            the java class
     */
    public ClassValidationException(final String message,
            final Class<?> pJavaClass) {
        this(message, pJavaClass, null);
    }
     ...
     */
    public ClassValidationException(final String message,
            final Class<?> pJavaClass, final Throwable cause) {
        super(message
                + String.format("\n(javaClass: [%s])", pJavaClass),
                cause);
