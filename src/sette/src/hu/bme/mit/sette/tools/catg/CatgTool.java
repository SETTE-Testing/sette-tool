...
public final class CatgTool extends Tool {
    ...
    public CatgTool(File toolDirectory, String version)
    ...
    public File getToolDirectory() throws SetteConfigurationException {
        try {
            ...
            throw new SetteConfigurationException(
                    "The CATG tool directory is invalid: "
                            + toolDirectory, e);
        }
