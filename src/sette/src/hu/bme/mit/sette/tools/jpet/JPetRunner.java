...
public final class JPetRunner extends RunnerProjectRunner<JPetTool> {
    ...
    public JPetRunner(SnippetProject snippetProject,
    ...
    protected void afterPrepare() throws IOException {
        ...
        File testCasesDirectory = getTool().getTestCasesDirectory(
                getRunnerProjectSettings());
        if (testCasesDirectory.exists()) {
            FileUtils.forceDelete(new File(getRunnerProjectSettings()
                    .getBaseDirectory(), JPetTool.TESTCASES_DIRNAME));
        }
    }
    ...
    protected void runOne(Snippet snippet, File infoFile,
        ...
        File testCaseXml = getTool().getTestCaseXmlFile(
        ...
        jPetName.append(JavaFileUtils.packageNameToFilename(snippet
        ...
        // return type
        System.err.println(snippet.getMethod().getReturnType()
                .getName()
                + "-"
                + snippet.getMethod().getReturnType()
                .getCanonicalName());
        jPetName.append(JPetTypeConverter.fromJava(snippet.getMethod()
                .getReturnType()));
