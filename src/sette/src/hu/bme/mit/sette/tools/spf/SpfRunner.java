...
public final class SpfRunner extends RunnerProjectRunner<SpfTool> {
    ...
    protected void runOne(Snippet snippet, File infoFile, File outputFile, File errorFile)
        ...
        File configFile = new File(getRunnerProjectSettings().getGeneratedDirectory(), filenameBase
                + JavaFileUtils.FILE_EXTENSION_SEPARATOR + JPFConfig.JPF_CONFIG_EXTENSION)
                        .getCanonicalFile();
