...
public final class SnippetContainerTreeNode extends
TreeNodeBase<SnippetProjectTreeNode, SnippetTreeNode> {
    private final SnippetContainer container;

    public SnippetContainerTreeNode(SnippetProjectTreeNode tnProject,
