...
public final class SnippetTreeNode extends
TreeNodeBase<SnippetContainerTreeNode, TreeNode> {
    private final Snippet snippet;

    public SnippetTreeNode(SnippetContainerTreeNode tnContainer,
            Snippet snippet) {
        super(tnContainer);
    ...
    public String getDescription() {
        try {
            ...
            sb.append(snippet.getMethod().toGenericString())
            .append('\n').append('\n');
            sb.append("Required statement coverage: "
            ...
            if (!snippet.getIncludedMethods().isEmpty()) {
                ...
                for (Method method : snippet.getIncludedMethods()) {
                    ...
                    .append(method.getDeclaringClass()
                            .getName()).append('\n');
                    sb.append("    ").append(method.toGenericString())
                    .append('\n');
                }
            ...
            if (snippet.getInputFactory() == null) {
                ...
                sb.append("Sample input count: "
                        + snippet.getInputFactory().getInputs().size());
            }
